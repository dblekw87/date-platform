export function DateLogo({ className }: { className?: string }) {
  return (
    <svg aria-hidden="true" className={className} fill="none" viewBox="0 0 55 28" xmlns="http://www.w3.org/2000/svg">
