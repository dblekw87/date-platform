...
export type LimitPairDto = {
   ...
   *
   * 2026-09-02에 분봉으로 그 구간을 쟀고 **성립하지 않았습니다** — 12개 장 149건,
   * 진입 뒤 마감까지 평균 −2.41%·상회 30%로, 같은 순간에 오르던 다른 급등주
   * (3,668건 −2.19%)와 구별되지 않습니다. 진입은 kr_signal_outcomes에 남은 실제
   * 발동 시각이라 사후 재구성이 아닙니다(`scripts/measure-pair-intraday.mjs`).
   *
